...
CREATE TABLE `blog_posts` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_blogposts_user` (`author_id`),
  CONSTRAINT `fk_blogposts_user` FOREIGN KEY (`author_id`) REFERENCES `users` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `post_categories` (
  ...
  PRIMARY KEY (`post_categories_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `post_categories` VALUES (1,1,1),(2,2,3),(3,3,1),(4,3,2),(5,4,2),(6,4,1),(7,5,1),(8,6,4);
...
-- Dump completed on 2025-08-15 14:08:27
